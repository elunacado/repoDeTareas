...
int main(int argc, char* argv[]) {
	    ...
	    string q_ans;
			...
			cout << endl <<  "Correct: " <<q_ans << endl ;
			cout << "Program: "<<quad_hash.toString().c_str() << endl ;
			...
			cout << endl <<  "Correct: "<< ans << endl ;
			cout <<  "Program: "<< quad_hash.get("casa") << endl ;
			...
			cout << endl <<  "Correct: "<<  ans << endl ;
			cout <<  "Program: "<< quad_hash.get("magneto") << endl ;
